      ...
      <div className="grid grid-cols-1 gap-y-8">
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Tu paquete llegará en 3-5 días hábiles a tu punto de recogida o
        ...
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              ¿El ajuste no es el correcto? No te preocupes, cambiaremos tu
        ...
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              ...
              Sin preguntas – haremos nuestro mejor esfuerzo para que tu
              devolución sea sin complicaciones.
            </p>
          </div>
        </div>
      </div>
